...
export default function WhyChooseUs() {
  const faqs = [
    { q: "Why should I choose PropertyCare Paint and Electrics Ltd?", a: "We deliver premium painting, decorating, electrical and maintenance through one accountable team. Certified, insured, and backed by a written guarantee — no juggling trades, no finger-pointing." },
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <div className="rv rv-d2" style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
              <p style={{ fontSize: 18, color: "#3D3A37", lineHeight: 1.8, fontWeight: 400 }}>
                At PropertyCare Paint and Electrics Ltd, we understand that inviting tradespeople into your home or business requires trust. That&rsquo;s why we focus on professionalism, communication, reliability and high-quality workmanship on every project.
              </p>
            </div>
          </div>
        </section>
