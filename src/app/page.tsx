    ...
    <>
      ...
      <main id="top">
        ...
        <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "flex-end", overflow: "hidden", background: "#0A0908" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, padding: "140px 52px 140px", maxWidth: 920, width: "100%" }}>
            ...
            <h1 className="h-a2" style={{
              ...
              Property Care,<br />
              <span style={{ color: "#F58220" }}>Paint &amp; Electrics</span>
            </h1>
            ...
            <div className="h-a5" style={{
              ...
              background: "rgba(255,255,255,0.06)", border: "2px solid rgba(245,130,32,0.35)",
              padding: "16px 24px", borderRadius: 6, backdropFilter: "blur(8px)",
            }}>
              <div style={{ width: 44, height: 44, background: "#F58220", borderRadius: 4, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5">
                  <path d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
              </div>
              <a href="tel:+447922909983" style={{ textDecoration: "none" }}>
                <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#F58220", marginBottom: 2 }}>
                  Call Now — Free Quote
                </div>
          ...
          <div className="h-a6" style={{ position: "absolute", bottom: 36, right: 52, zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
            ...
            <div className="scroll-drip" style={{ width: 2, height: 60, background: "linear-gradient(to bottom, #F58220, transparent)" }} />
          </div>
          ...
          <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 24 }} className="trust-grid">
            {[
              ...
              <div key={label} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 36, height: 36, background: "#FFE8D4", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <CheckIcon size={18} />
                </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }} className="grid-2">
              <div>
                ...
                <h2 className="rv rv-d1" style={{
                  ...
                  One Team.<br />
                  Four Disciplines.<br />
                  <span style={{ color: "#F58220" }}>Zero Compromise.</span>
                </h2>
              ...
              <div>
                ...
                <div className="rv rv-d2" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 1, background: "#0A0908", border: "1px solid #0A0908" }}>
                  {[["100%","Certified"],["5★","Rated"],["1","Contact"],["£0","Survey"]].map(([n, l]) => (
                    <div key={l} style={{ background: "#0A0908", padding: "26px 14px", textAlign: "center", borderRight: "1px solid rgba(245,130,32,0.15)" }}>
                      <div style={{ fontSize: 38, fontWeight: 900, color: "#F58220", lineHeight: 1, letterSpacing: "-0.02em" }}>{n}</div>
          ...
          <div style={{ maxWidth: 1400, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 72 }}>
              <div className="rv"><OrangeTab center>What We Do</OrangeTab></div>
                ...
                Premium Services<br />
                <span style={{ color: "#F58220" }}>Across The North East</span>
              </h2>
                ...
                <div key={title} className={`svc-card rv rv-d${idx + 1}`}>
                  ...
                  <div style={{ padding: "32px 28px 36px", flex: 1, display: "flex", flexDirection: "column" }}>
                    ...
                    <a href="#contact" style={{
                      ...
                      textTransform: "uppercase", color: "#F58220", textDecoration: "none",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }} className="grid-2">
              <div>
                ...
                <h2 className="rv rv-d1" style={{
                  ...
                  Drag To Reveal<br />
                  <span style={{ color: "#F58220" }}>A Real Transformation</span>
                </h2>
                ...
                <div className="rv rv-d3" style={{ marginBottom: 36, padding: "24px 28px", background: "#F8F5F0", borderLeft: "4px solid #F58220", borderRadius: 4 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.2em", textTransform: "uppercase", color: "#F58220", marginBottom: 8 }}>
        ...
        {/* ══════════════════════════════════════
            WHY US — DARK
        ══════════════════════════════════════ */}
        <section style={{ padding: "120px 52px", background: "#0A0908", borderTop: "4px solid #F58220" }} id="whyus">
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.06)" }} className="grid-3">
              {[
                ...
                <div key={n} className={`why-card rv rv-d${(i % 3) + 1}`} style={{ background: "rgba(248,245,240,0.025)", padding: "48px 36px", borderRight: "1px solid rgba(255,255,255,0.04)" }}>
                  <div className="why-num" style={{ fontSize: 56, fontWeight: 900, lineHeight: 1, color: "rgba(245,130,32,0.18)", marginBottom: 22, transition: "color 0.3s, opacity 0.3s", letterSpacing: "-0.02em" }}>{n}</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1.8fr", gap: 80, alignItems: "start" }} className="grid-2">
              <div>
                ...
                <h2 className="rv rv-d1" style={{ fontSize: "clamp(36px, 4vw, 56px)", fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.02em", color: "#0A0908", marginBottom: 22, textTransform: "uppercase" }}>
                  Serving The<br /><span style={{ color: "#F58220" }}>North East</span>
                </h2>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 28 }} className="grid-3">
              {[
                ...
                <div key={name} className={`testi-card rv rv-d${d}`} style={{ background: "#F8F5F0", border: "2px solid #E8E2D9", padding: "40px 36px", position: "relative", borderRadius: 4 }}>
                  <div style={{ position: "absolute", top: 0, left: 0, width: 60, height: 4, background: "#F58220" }} />
                  <div style={{ display: "flex", gap: 4, marginBottom: 18 }}>
                    {[1,2,3,4,5].map(i => <svg key={i} width="16" height="16" viewBox="0 0 24 24" fill="#F58220"><path d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" /></svg>)}
                  </div>
                  <p style={{ fontSize: 16, fontWeight: 400, color: "#1A1917", lineHeight: 1.7, marginBottom: 28 }}>
                    &ldquo;{q}&rdquo;
                  </p>
                  <div style={{ borderTop: "1px solid #E8E2D9", paddingTop: 18 }}>
                    <div style={{ fontSize: 14, fontWeight: 800, marginBottom: 3, color: "#0A0908", letterSpacing: "-0.01em" }}>{name}</div>
          ...
          <div style={{ position: "relative", zIndex: 1, padding: "120px 52px", textAlign: "center" }}>
            <div style={{ maxWidth: 800, margin: "0 auto" }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                Tell Us About<br /><span style={{ color: "#F58220" }}>Your Space</span>
              </h2>
              ...
              <div className="rv rv-d3" style={{ display: "flex", justifyContent: "center", gap: 14, flexWrap: "wrap", marginBottom: 40 }}>
                ...
                <a href="sms:+447922909983" className="btn-outline-light">Text 07922 909983</a>
              </div>

              {/* Big premium phone */}
              <div className="rv rv-d4" style={{
                display: "inline-flex", alignItems: "center", gap: 20,
                background: "rgba(255,255,255,0.05)", border: "2px solid rgba(245,130,32,0.4)",
                padding: "24px 36px", borderRadius: 6,
              }}>
                <div style={{ width: 56, height: 56, background: "#F58220", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, boxShadow: "0 8px 24px rgba(245,130,32,0.4)" }}>
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5">
                    <path d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                  </svg>
                </div>
                <a href="tel:+447922909983" style={{ textDecoration: "none", textAlign: "left" }}>
                  <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: "0.22em", textTransform: "uppercase", color: "#F58220", marginBottom: 4 }}>
                    Or Call Us Directly
                  </div>
