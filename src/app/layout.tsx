...
export const metadata: Metadata = {
  ...
  description: "Sunderland's premium painting & decorating, electrical & lighting, bespoke media walls and property maintenance. One certified team. Free quotes. Fully insured.",
  keywords: "Painter and Decorator Sunderland, Electrician Sunderland, Media Wall Sunderland, Property Maintenance Sunderland, North East",
  openGraph: {
    title: "Propertycare Paints & Electrics | Premium Property Transformations",
    description: "One certified team for painting, electrical, media walls and maintenance across Sunderland and the North East.",
    ...
    <html lang="en-GB" className={inter.variable}>
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          address: { "@type": "PostalAddress", addressLocality: "Sunderland", addressRegion: "Tyne and Wear", addressCountry: "GB" },
          areaServed: ["Sunderland","Washington","Seaham","South Shields","Gateshead","Newcastle upon Tyne","Durham"],
          openingHours: "Mo-Fr 07:00-18:00", priceRange: "££",
        }) }} />
      </head>
      <body>{children}</body>
    </html>
