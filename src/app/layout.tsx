...
export const metadata: Metadata = {
  title: "Property Care Paint & Electrics Ltd | Sunderland's Trusted Property Specialists",
  description:
  ...
  openGraph: {
    title: "Property Care Paint & Electrics Ltd | Premium Property Services",
    description:
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              name: "Property Care Paint & Electrics Ltd",
              description:
