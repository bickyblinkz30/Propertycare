...
export const metadata: Metadata = {
  ...
  description:
    `Meet ${brand.full} — a Sunderland-based team of certified painters, electricians and property specialists delivering every project through one accountable team.`,
  openGraph: {
    title: `About Us | ${brand.full}`,
    description:
