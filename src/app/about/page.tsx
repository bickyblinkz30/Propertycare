    ...
    <>
      ...
      <main id="top">
        ...
        <section style={{ position: "relative", minHeight: "55vh", display: "flex", alignItems: "center", overflow: "hidden", background: "#0A0908" }}>
          ...
          <img src={aboutImages.hero} alt="Home renovation in progress — room prepared with protective sheeting" fetchPriority="high" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 30%", opacity: 0.68 }} />
