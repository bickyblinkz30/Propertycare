    ...
    <>
      ...
      <main id="top">
        ...
        <section style={{ position: "relative", minHeight: "80vh", display: "flex", alignItems: "center", overflow: "hidden", background: "#0A0908" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, padding: "140px 52px", maxWidth: 920, width: "100%" }}>
            ...
            <h1 className="h-a2" style={{
              ...
              One team,<br />
              <span style={{ color: "#C9A227" }}>one standard</span>
            </h1>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div className="rv" style={{ textAlign: "center", marginBottom: 72 }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                Built To Be<br /><span style={{ color: "#C9A227" }}>Different.</span>
              </h2>
            </div>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div className="rv" style={{ marginBottom: 72 }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                What We <span style={{ color: "#C9A227" }}>Stand For.</span>
              </h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "#E8E2D9", border: "1px solid #E8E2D9", borderRadius: 4, overflow: "hidden" }} className="grid-3">
              {[
                ...
                <div key={num} className={`rv rv-d${(i % 3) + 1}`} style={{ background: "#FDFCFB", padding: "44px 36px" }}>
                  <div style={{ fontSize: 52, fontWeight: 900, lineHeight: 1, color: "rgba(201,162,39,0.15)", marginBottom: 20, letterSpacing: "-0.02em" }}>{num}</div>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div className="rv" style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                The Person Behind<br /><span style={{ color: "#C9A227" }}>The Transformations.</span>
              </h2>
            </div>
            ...
            <div style={{ maxWidth: 760, margin: "0 auto" }}>
              ...
              <div>
                <div className="rv rv-d1" style={{ marginBottom: 24 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "#C9A227", marginBottom: 12 }}>
                ...
                <div className="rv rv-d4" style={{ marginBottom: 28 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {[
                      ...
                      <div key={exp.yr} style={{ display: "flex", gap: 20, padding: "14px 18px", background: "#F8F5F0", borderRadius: 4, borderLeft: "3px solid #C9A227" }}>
                        <div style={{ fontSize: 12, fontWeight: 700, color: "#C9A227", flexShrink: 0, width: 130, letterSpacing: "0.04em" }}>{exp.yr}</div>
                        <div>
        ...
        {/* ══════════════════════════════════════
            CTA
        ══════════════════════════════════════ */}
        <section style={{ background: "#0A0908", borderTop: "4px solid #C9A227", padding: "120px 52px", textAlign: "center" }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <h2 className="rv rv-d1" style={{
              ...
              Ready To Transform<br /><span style={{ color: "#C9A227" }}>Your Property?</span>
            </h2>
