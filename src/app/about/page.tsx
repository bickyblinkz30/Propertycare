        ...
        <section style={{ position: "relative", minHeight: "55vh", display: "flex", alignItems: "center", overflow: "hidden", background: "#0A0908" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, padding: "100px 52px 80px", maxWidth: 920, width: "100%" }}>
            ...
            <h1 className="h-a2" style={{
              ...
              One team,<br />
              <span style={{ color: "var(--color-accent)" }}>one standard</span>
            </h1>
            <p className="h-a3" style={{
              ...
              We are PropertyCare Paints & Electrics Ltd &mdash; a Sunderland-based team of certified painters, electricians and property specialists. Every project is delivered by one accountable team from start to finish.
            </p>
            <div className="h-a4">
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div className="rv" style={{ textAlign: "center", marginBottom: 72 }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                Built To Be<br /><span style={{ color: "var(--color-accent)" }}>Different.</span>
              </h2>
            </div>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            <div className="rv" style={{ marginBottom: 72 }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                What We <span style={{ color: "var(--color-accent)" }}>Stand For.</span>
              </h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "#E8E2D9", border: "1px solid #E8E2D9", borderRadius: 4, overflow: "hidden" }} className="grid-3">
              {[
                ...
                <div key={num} className={`rv rv-d${(i % 3) + 1}`} style={{ background: "#FDFCFB", padding: "44px 36px" }}>
                  <div style={{ fontSize: 52, fontWeight: 900, lineHeight: 1, color: "rgba(var(--color-accent-rgb),0.15)", marginBottom: 20, letterSpacing: "-0.02em" }}>{num}</div>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div className="rv" style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              <h2 className="rv rv-d1" style={{
                ...
                The Person Behind<br /><span style={{ color: "var(--color-accent)" }}>The Transformations.</span>
              </h2>
            </div>

            <div style={{ maxWidth: 760, margin: "0 auto" }}>
              {/* Info (text-only — founder photo intentionally omitted until a real headshot is available) */}
              <div>
                <div className="rv rv-d1" style={{ marginBottom: 24 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--color-accent)", marginBottom: 12 }}>
                ...
                <div className="rv rv-d3" style={{ marginBottom: 28 }}>
                  ...
                  <p style={{ fontSize: 15, color: "#3D3A37", lineHeight: 1.8, fontWeight: 400, marginBottom: 16 }}>
                    Chukwudi founded PropertyCare Paints & Electrics Ltd with a clear mission: deliver premium property transformations through one accountable team. With combined expertise in painting, decorating, and electrical work, he personally ensures every project meets the highest standards of craftsmanship and professionalism.
                  </p>
                ...
                <div className="rv rv-d4" style={{ marginBottom: 28 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {[
                      { yr: "2020 — Present", title: "Founder & Managing Director", org: "PropertyCare Paints & Electrics Ltd, Sunderland" },
        ...
        <section style={{ background: "#0A0908", borderTop: "4px solid var(--color-accent)", padding: "120px 52px", textAlign: "center" }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <h2 className="rv rv-d1" style={{
              ...
              Ready To Transform<br /><span style={{ color: "var(--color-accent)" }}>Your Property?</span>
            </h2>
