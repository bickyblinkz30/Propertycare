  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 11, color: "var(--color-accent)", letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700 }}>{t.detail}</div>
      </div>
              ...
              {items.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    background: i === idx ? "var(--color-accent)" : "#D8D0C4",
